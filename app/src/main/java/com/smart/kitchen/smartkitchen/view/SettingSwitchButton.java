...
public class SettingSwitchButton extends LinearLayout implements OnClickListener {
    ...
    public void setText(boolean z) {
        ...
        if (this.IS_OPEN) {
            ...
            this.tv_buttom.setBackgroundResource(R.drawable.circle_red);
            this.v_swicther.setBackgroundResource(R.drawable.corner_red);
        } else {
    ...
    public void startAnim() {
        ...
        translateAnimation.setAnimationListener(new AnimationListener() {
            public void onAnimationStart(Animation animation) {
                SettingSwitchButton.this.is_moving = true;
            }

            public void onAnimationEnd(Animation animation) {
                SettingSwitchButton.this.is_moving = false;
                SettingSwitchButton.this.setText(true);
            }
    ...
    public void startAnimResove() {
        ...
        translateAnimation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                SettingSwitchButton.this.is_moving = false;
                SettingSwitchButton.this.setText(false);
            }
